...
import com.recycle.pad.net.action.category.GetCategoryDetailReq;
import com.recycle.pad.net.action.category.GetCategoryReq;
import com.recycle.pad.net.action.life.GetLifeReq;
import com.recycle.pad.net.action.life.GetTitleLifeReq;
...
public class CategoryManager {
	...
	public ArrayList<CategoryInfo> getCategory(Context context,final String parentId,final DataResponseListener<Boolean> listener){
	...
	public void getCategoryDetail(Context context,final String categoryId,final DataResponseListener<JackJson> listener){
	...
	public ArrayList<LifeGoods> getLifeList(Context context,final String typeId,final DataResponseListener listener){
	...
	public ArrayList<CategoryInfo> getLifeTitleList(Context context,final DataResponseListener listener){
